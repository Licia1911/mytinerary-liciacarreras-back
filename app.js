...
import cors from 'cors'  // Modulo para desbloquear las politicas de Cors (origenes cruzados server front=5173 y server back=8080)
...
app.use(cors());                                          //obligo al servidor a desbloquear la politica de cors(orígenes cruzados)
